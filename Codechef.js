...
var hh = document.getElementById('ember251').children[0].children[1].children[0].children[0].children[0].innerHTML
var header_string = ""
for (var i = 1; i < hh.length; i++) {
    if (hh.charAt(i) == '\n') break;
    header_string = header_string + hh.charAt(i);
}
var v1 = document.getElementById('ember251').children[0].children[2].children[0]
